...
//1 игрок;2 стена;3 мяч;4 корзина;5 пусто;
    ...
    MyMap.push_back({{2,2,2,2,2,2,2,2,2,2},
                     {2,4,5,5,5,5,5,5,4,2},
                     {2,2,2,2,5,5,2,2,2,2},
                     {2,5,5,5,5,5,5,5,5,2},
                     {2,5,3,5,5,5,5,3,5,2},
...
void Widget::on_load_clicked()
{
    ...
    if(str.length()!=100){
        (new QErrorMessage(this))->showMessage("Это не карта! Карта должна быть 10 на 10");
        return;
    }
